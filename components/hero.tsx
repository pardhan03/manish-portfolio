...
import { RiNextjsFill, RiReactjsFill, RiTwitterXLine, RiNodejsFill } from "react-icons/ri"
      ...
      <div className="grid md:grid-cols-3 gap-10 items-center max-w-6xl mx-auto">
        ...
        >
          <div className="space-y-2">
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">Manish Pardhan</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 text-sm text-muted-foreground">
            <div className="flex items-center gap-1">
              ...
              <a href="mailto:pardhanmanish7887@gmail.com">pardhanmanish7887@gmail.com</a>
            </div>
            <div className="flex items-center gap-1">
          ...
          <p className="text-muted-foreground text-sm sm:text-base">
            A goal-oriented software developer skilled in building modern web and mobile applications using technologies like
            React.js and React Native. Focused on delivering seamless, high-quality user experiences through clean architecture
            and efficient code.
          </p>
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            ...
            <Link
              href="https://github.com/pardhan03"
              target="_blank"
            >
